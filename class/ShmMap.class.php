...
class ShmMap extends SMC_Post
{
	...
	static function save_admin_edit($obj)
	{
		return [
		    ...
		    "is_personal_data"	=> sanitize_text_field($_POST['is_personal_data']),			
		    "is_name_iclude"	=> sanitize_text_field($_POST['is_name_iclude']),			
		    "personal_name"		=> sanitize_text_field($_POST['personal_name']),			
		    "is_name_required"	=> sanitize_text_field($_POST['is_name_required']),			
		    "is_email_iclude"	=> sanitize_text_field($_POST['is_email_iclude']),			
		    "personal_email"	=> sanitize_text_field($_POST['personal_email']),			
		    "is_email_required"	=> sanitize_text_field($_POST['is_email_required']),			
		    "is_phone_iclude"	=> sanitize_text_field($_POST['is_phone_iclude']),			
		    "personal_phone"	=> sanitize_text_field($_POST['personal_phone']),			
		    "is_phone_required"	=> sanitize_text_field($_POST['is_phone_required']),			
		];
	}
